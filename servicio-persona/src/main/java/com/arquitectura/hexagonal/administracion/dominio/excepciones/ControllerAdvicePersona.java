...
@ControllerAdvice
public class ControllerAdvicePersona extends ResponseEntityExceptionHandler {
    ...
    public ControllerAdvicePersona() {
        CODIGOS_ESTADO.put(PersonaNotFoundExcepcion.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(PersonaDuplicadaExcepcion.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put("MethodArgumentNotValidException", HttpStatus.BAD_REQUEST.value());
