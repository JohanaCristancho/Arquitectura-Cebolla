...
@ControllerAdvice
public class ControllerAdviceImagen extends ResponseEntityExceptionHandler {
    ...
    public ControllerAdviceImagen() {
        CODIGOS_ESTADO.put(ImagenDataDuplicada.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ImagenNotFoundExcepcion.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
